...
export default function ProductDetails({ vehicle }: { vehicle: Vehicle }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-200 via-neutral-50 to-green-950 text-white">
      {/* Hero / gallery */}
      <motion.header
        style={{ translateY }}
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="relative rounded-xs overflow-hidden ring-1 ring-white/6 shadow-2xl">

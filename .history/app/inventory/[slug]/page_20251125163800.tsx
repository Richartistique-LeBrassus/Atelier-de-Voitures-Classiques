    ...
    <div className="min-h-screen bg-white text-neutral-950 uppercase">
            ...
            >
              <div className="sticky top-6 uppercase text-neutral-950">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <button className="py-3 px-4   border font-semibold hover:scale-[1.01] transition-transform">
                    Book Viewing
                  </button>
      ...
      <main className="max-w-[1400px] mx-auto px-6 lg:px-10 py-12 lg:py-20 uppercase">
        ...
        >
          ...
          <aside className="bg-linear-to-b from-slate-900/40 to-black/40 p-6 rounded-2xl border border-white/6">

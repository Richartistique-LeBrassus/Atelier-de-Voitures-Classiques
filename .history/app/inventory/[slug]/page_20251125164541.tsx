      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="sticky top-6 uppercase text-neutral-950">
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex gap-3">
                <input
                  ...
                  className="w-full rounded-lg bg-white/5 p-2 placeholder:text-slate-400"
                />
      ...
      <footer className="border-t border-white/6 mt-12">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3 uppercase">
            <button className="px-6 py-3 font-semibold uppercase">Call</button>
            <button className="px-6 py-3 uppercase">Send inquiry</button>
          </div>
        </div>
      </footer>
    </div>

      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="sticky top-6 uppercase text-neutral-950 shadow">
                ...
                <div className="mt-6 p-4  bg-white/2 border border-white/6 backdrop-blur-md shadow-xs">

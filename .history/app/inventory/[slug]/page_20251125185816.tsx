...
export default function ProductDetails({ vehicle }: { vehicle: Vehicle }) {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-950 uppercase py-14">
      {/* Hero / gallery */}
      <motion.header
        style={{ translateY }}
      ...
      >
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-10 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="sticky top-6 uppercase text-neutral-950 shadow sm:p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="text-3xl md:text-4xl 
                    font-semibold tracking-tight">{demo.title}</h1>
                ...
                <div className="mt-6 p-4  bg-white/2 border 
      ...
      mx-auto px-6 lg:px-10 py-12 lg:py-20 uppercase">
        <motion.section
        ...
        >
          ...
          p-6 border border-white/6 shadow-lg">

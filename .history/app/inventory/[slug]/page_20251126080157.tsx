      ...
      >
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-10 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="relative overflow-hidden ring-1 ring-white/6 shadow-2xl">
                <div className="relative aspect-16/10 w-full">
                  ...
                  <motion.div
                    style={{ filter: blur }}
                    className="absolute inset-0 -z-10 bg-linear-to-t from-black/60 
            ...
            >
              <div className="sticky top-12 uppercase text-neutral-950 sm:shadow sm:p-4 
                md:py-12"
              >
                <div className="flex items-center justify-between">
                  <div className="h-fit space-y-6">
                    <h1 className="text-5xl 
                    font-bold tracking-tighter font-mono">{demo.title}</h1>
                    <p className="mt-5">{demo.subtitle}</p>
                    <div className="text-xl sm:text-2xl font-semibold">{demo.price}</div>
                    <div className="text-xs sm:text-sm">{demo.location}</div>
                  </div>
                </div>

                <div className="mt-6 grid grid-cols-2 gap-3">
                  <button className="py-3 px-4 uppercase border 
                  font-semibold hover:scale-[1.01] transition-transform">
                    Book Viewing
                  </button>
                  <button className="py-3 px-4  bg-white/6 border 
                  border-white/8 text-white/90 font-semibold 
                ...
                >
                  ...
                  <ul className="mt-3 grid grid-cols-2 gap-2 italic">
                    {(demo.features ?? []).map((f) => (
      ...
      mx-auto sm:px-6 lg:px-10 py-12 lg:py-20 uppercase">
        ...
        >
          ...
          p-6 border border-white/6 sm:shadow-xs">
            ...
            <p className="mt-4 leading-relaxed line-clamp-5">{demo.description}</p>

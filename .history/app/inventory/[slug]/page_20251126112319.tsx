      ...
      >
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-10 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            >
              <div className="relative overflow-hidden lg:my-auto lg:py-auto">
      ...
      <footer className="border-t border-white/6 mt-12">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 
         flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3 uppercase text-xl mt-3">
  <button className="px-6 py-3 font-semibold uppercase font-mono flex items-center gap-2">
    <Phone className="w-5 h-5" />
    Call
  </button>

  <button className="px-6 py-3 uppercase font-mono flex items-center gap-2">
        ...
        {gallery.map((img, i) => (
          <div key={i} className="snap-center w-full">
            <Image
              ...
              width={900}
              height={600}
              className="object-cover h-full w-[15vh] lg:w-[20vh]"
            />
          </div>
        ))}
      </div>

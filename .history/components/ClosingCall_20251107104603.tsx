...
export default function ClosingCall() {
  return (
    <section
      ...
      items-center gap-12 py-24 px-5 md:px-16 bg-neutral-100 text-black"
    >
      ...
      >
        ...
        <p className="font-extrabold font-mono uppercase">
          DISCALIMER: VISITS BY APPOINTMENT ONLY
        </p>

        <p className="text-base md:text-lg text-neutral-600 font-mono">
          We invite you to experience our workshop — to witness the craft, 

  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-bold font-mono uppercase leading-9 sm:leading-8 underline underline-offset-6">
        ...
        <div>
          <a
            href="/contact"
            className="inline-block border-b border-black pb-1 text-lg uppercase
            tracking-wide hover:opacity-60 transition-opacity"
          >
            Discover the Essex Workshop
          </a>
        </div>
      </motion.div>

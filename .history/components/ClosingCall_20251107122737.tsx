...
export default function ClosingCall() {
  return (
    <div 
      ...
      className="w-full h-fit z-30 px-auto bg-neutral-50"
    >
      <section
        className="w-full mx-auto
         grid grid-cols-1 lg:grid-cols-2
        items-center gap-12 py-24 px-5 md:px-16 text-neutral-950 max-w-7xl"
      >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="space-y-6 max-w-md mx-auto items w-full flex flex-col"
        >
          <h2 className="uppercase font-bold text-4xl sm:text-5xl md:text-5xl lg:text-6xl tracking-[0.3rem]">

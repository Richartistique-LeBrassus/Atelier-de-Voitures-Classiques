...
export default function ClosingCall() {
  return (
    <section 
      ...
      className="sticky top-0 h-screen z-3 min-h-screen
      w-full h-fit px-auto bg-neutral-50 px-5 md:px-7
      py-7 sm:py-12 md:py-16 lg:py-28"
    >
      <div
        className="w-full mx-auto
        grid grid-cols-1 2xl:gap-5 2xl:grid-cols-2
      ...
      >  
        ...
        >
          ...
          <div className="flex flex-col gap-7 font-mono mb-5 sm:sm:mb-24 xl:mb-16">

    ...
    >
      ...
      <div className="z-10 max-w-4xl px-6 text-center py-24">
        <h2 className="text-4xl md:text-5xl font-light tracking-wide mb-6">
          Prill Porsche Classics — A Legacy of Precision, Passion, and Performance
        </h2>
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
          Founded by mechanical engineer and lifelong motorsport enthusiast <strong>Andy Prill</strong>,
          Prill Porsche Classics embodies a deep respect for Porsche’s engineering excellence and racing
          heritage. From humble beginnings restoring a 1968 Porsche 912 to building a world-class reputation
          for precision engine building, restoration, and race preparation, Andy’s journey has been defined
          by craftsmanship and authenticity. What began as <strong>AJP Engineering</strong> in the 1990s
          evolved into a globally respected atelier specializing in Porsche models from 1948 to 1974. Today,
          operating from purpose-built facilities in North Essex, Prill Porsche Classics continues to honour
          the marque’s legacy—combining meticulous engineering, unrivalled expertise, and an enduring passion
          for classic Porsche excellence.
        </p>
      </div>

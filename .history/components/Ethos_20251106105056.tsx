    ...
    >
      ...
      <div className="z-10 max-w-4xl px-6 text-center py-24">
        ...
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
          Guided by the spirit of Andy Prill, a lifelong engineer and racer, Prill Porsche Classics is born from passion, family, and the timeless artistry of Porsche.
          Inspired by the soul of icons like Steve McQueen as are countless many, Andy restores each machine as a living sculpture of speed and memory.

    ...
    >
      ...
      <div className="z-10 max-w-4xl px-6 text-center py-24">
        ...
        flex-wrap max-w-[270px]">
          ...
          <span className="font-bold font-mono tracking-tighter">Unrivalled<br/><span className="">Experience</span></span>
          <br/>
          <span className="font-bold font-mono tracking-tighter">Unrivalled<br/><span className="">Expertise</span></span>                    
        </h2>

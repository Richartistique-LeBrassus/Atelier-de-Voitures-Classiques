  ...
  return (
    ...
    >
      ...
      <div className="z-10 max-w-4xl px-6 text-center py-24">
        <h2 className="text-5xl mb-16 uppercase text-left tracking-[0.3rem]
        flex-wrap max-w-[270px]">
          Prill Porsche Classics <br/>
          <span className="font-bold font-mono">Unrivalled<br/>Experience</span>
          <br/>
          <span className="font-bold font-mono">Unrivalled<br/>Expertise</span>                    
        </h2>

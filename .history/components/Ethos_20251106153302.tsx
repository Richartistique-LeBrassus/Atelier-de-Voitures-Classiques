...
const Ethos = () => {
  return (
    ...
    >
      ...
      <div className="z-10 max-w-4xl px-6 text-center py-20">
        ...
        <p className="leading-relaxed font-mono text-left">
          Guided by the spirit of <span className="font-extrabold">Automotive Connoisseur Andy Prill,</span>           
        ...
        <div className="ap-lookbook-app initialized-ApLookbook" data-v-app="">
          <div className="ap-lookbook-wrapper ap-lookbook-wrapper--black">
            <div data-v-1367169b="" 
              ...
              grid grid-cols-1 md:grid-cols-2 gap-4 px-6 pb-24">

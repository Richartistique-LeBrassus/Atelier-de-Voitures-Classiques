...
const Ethos = () => {
  return (
    ...
    >
      ...
      <div className="z-10 max-w-4xl text-center py-20">
        ...
        <p className="leading-relaxed font-mono text-left px-1">

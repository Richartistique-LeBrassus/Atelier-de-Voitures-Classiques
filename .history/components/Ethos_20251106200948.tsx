...
const Ethos = () => {
  return (
    <section
      ...
      px-5 md:px-7"
    >
      <div className="z-10 max-w-7xl w-full lg:inline-flex lg:justify-between py-20">
        <div className="lg:flex lg:flex-col">
          <h2 className="text-4xl sm:text-5xl mb-10 uppercase text-left tracking-[0.3rem]
          flex-wrap max-w-[270px] lg:font-bold">
            Prill Porsche Classics <br/>                             
          </h2>
          <div className="w-full inline-flex text-end">
        ...
        <p className="leading-9 font-mono text-left lg:max-w-[470px] indent-12">

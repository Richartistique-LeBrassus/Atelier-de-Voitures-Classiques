    ...
    >
      ...
      >
        <div className="lg:flex lg:flex-col">
          <h2 className="text-4xl sm:text-5xl xl:text-6xl mb-10 uppercase text-left tracking-[0.3rem]
          flex-wrap max-w-[270px] font-bold">
            Prill Porsche Classics <br/>                             
          </h2>
          <div className="w-full inline-flex text-end lg:p-5 xl:px-9">
            <h2 className="text-4xl md:text-5xl xl:text-6xl mb-16 uppercase text-left tracking-[0.3rem]
        ...
        <p className="leading-9 sm:leading-8 font-mono text-left lg:max-w-[470px] indent-12 
          lg:h-full items-end align-bottom 
          xl:max-w-[560px]  xl:p-5"
        >
      ...
      <div className="lookbook container responsivegrid w-full max-w-7xl">
            <div data-v-1367169b="" 
              className=" 
              grid grid-cols-1 xl:grid-cols-2 gap-4 pb-24">

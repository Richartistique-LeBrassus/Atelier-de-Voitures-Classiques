...
const Ethos = () => {
  return (
    <section
      ...
      className="sticky top-0 flex flex-col items-center justify-center w-full 
      bg-white text-neutral-950 overflow-y-scroll min-h-fit 
    ...
    >
      ...
      >
        <div className=" lg:flex-col">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl mb-10 sm:mb-16 xl:mb-10

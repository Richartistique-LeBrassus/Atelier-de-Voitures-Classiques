...
export default function Footer() {
  return (
    ...
    px-4 flex flex-col items-center justify-center space-y-5 
    text-center border-t border-white/10">
      ...
      <h4 className="text-sm md:text-base tracking-widest uppercase text-white/70 font-mono">
        Graeme Hunt London <br/>Ltd.
      </h4>

      <p className="text-xs md:text-sm text-white/40 max-w-md leading-relaxed font-mono uppercase">
        1A The Garages<br/> Coppock Close<br/> Battersea SW11 2LE
      </p>

      <div className="w-full flex flex-wrap space-x-6 pt-4 md:px-8 uppercase">
        <a
          href="#"

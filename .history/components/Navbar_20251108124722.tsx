      ...
      >
        ...
        >
          ...
          text-lg md:text-xl font-bold text-black uppercase">
            <<p className="relative tracking-[0.8rem] inline-block after:content-[''] after:absolute after:left-0 after:bottom-0 after:right-[0.4rem] after:h-[1px] after:bg-black">
  PRILL
</p>

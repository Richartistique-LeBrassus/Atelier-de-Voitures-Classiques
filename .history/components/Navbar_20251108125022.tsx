...
export default function Navbar() {
  ...
  return (
    <>
      {/* Navbar */}
      <nav
        className={`fixed top-0 left-0 w-full z-50 flex items-center justify-between px-5 py-5 transition-all duration-500 ${
          isScrolled
      ...
      >
        ...
        >
          ...
          text-lg md:text-xl font-bold text-black uppercase">
            <p className="pl- relative tracking-[0.92rem] inline-block 

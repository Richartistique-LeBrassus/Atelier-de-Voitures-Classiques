...
export default function Navbar() {
  ...
  return (
    <>
      {/* Navbar */}
      <nav
        className={`fixed top-0 left-0 w-full z-50 flex items-center justify-between px-4 py-5 transition-all duration-500 ${
          isScrolled
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col font-mono w-[120px] sm:w-[140px]
          text-lg sm:text-2xl font-extrabold text-black uppercase">
            <p className="relative tracking-[0.92rem] inline-block 

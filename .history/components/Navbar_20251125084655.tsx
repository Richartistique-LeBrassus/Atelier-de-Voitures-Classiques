  ...
  return (
    <>
      <motion.nav
        ...
        variants={{
          visibleNav: { y: 0, opacity: 1, transition: { duration: 0.6, ease: "easeInOut" } },
          hiddenNav: { y: "-100%", opacity: 0, transition: { duration: 0.6, ease: "easeInOut" } },
        }}
        className={`fixed top-0 left-0 w-full z-50 flex items-center justify-between
          px-4 md:px-7 py-5 md:py-8 transition-all duration-500
          ${isScrolled ? "backdrop-blur-md bg-white/30" : "bg-transparent backdrop-blur-0"}
        `}
      >
        {/* Burger Menu */}
        <button
        ...
        >
          <div
            className="flex  font-mono w-full 

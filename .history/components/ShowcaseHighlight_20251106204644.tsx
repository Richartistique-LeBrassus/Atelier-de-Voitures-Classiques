...
export default function ShowcaseHighlight({
  items = [
    { src: "/images/911-restoration.jpg", caption: "Porsche 911 • 1971" },
    { src: "/images/356-engine.jpg", caption: "Porsche 356 • 1958" },
    { src: "/images/workshop-detail.jpg", caption: "Engine Rebuild • 2024" },
  ],
}: Props) {
  return (
    <section
    ...
    >
      <div className="flex snap-x snap-mandatory">
        {items.map((item, i) => (
          <motion.figure
            key={i}
            className="relative flex-shrink-0 w-full md:w-[90vw] h-[70vh] snap-center overflow-hidden"
